...
unsigned char accX_H[2];

int accX,accY,accZ,graX,graY,graZ;
unsigned int steps = 0;
unsigned char steps_buff[7] ;
long stoss = 0;
long barrier = 0;
...
//            printDebugString("msg send rsp success\n"); 
  ...
  if ( events & SAMPLEAPP_TIMEOUT_EVT )
  {
    ...
    osal_start_timerEx( appSample_TaskID, SAMPLEAPP_TIMEOUT_EVT,
        (20 + (osal_rand() & 0x00FF)) );
    InitMPU6050();
//    graX = GetData(GYRO_XOUT_H);
//    graY = GetData(GYRO_YOUT_H);
//    graZ = GetData(GYRO_ZOUT_H);
    accX = GetData(ACCEL_XOUT_H);
    accY = GetData(ACCEL_YOUT_H);
    accZ = GetData(ACCEL_ZOUT_H); 
    stoss = absi(accX) + absi(accY) + absi(accZ);
    
    barrier = 3*5000l + 9000l;
    if (stoss > barrier) {
      steps++;
    }
    if(time0_count < 10)
      ...
      steps_buff[0] = steps/10000;
      steps_buff[1] = steps/1000%10;
      steps_buff[2] = steps/100%10;
      steps_buff[3] = steps/10%10;
      steps_buff[4] = steps%10;
      
      switch(steps_buff[0]){
        case 0 : steps_buff[0] = 48;
        break;              
        case 1 : steps_buff[0] = 49;
        break;              
        case 2 : steps_buff[0] = 50;
        break;              
        case 3 : steps_buff[0] = 51;
        break;              
        case 4 : steps_buff[0] = 52;
        break;              
        case 5 : steps_buff[0] = 53;
        break;              
        case 6 : steps_buff[0] = 54;
        break;              
        case 7 : steps_buff[0] = 55;
        break;              
        case 8 : steps_buff[0] = 56;
        break;              
        case 9 : steps_buff[0] = 57;
        break;
        default :break;
      }
      switch(steps_buff[1]){
        case 0 : steps_buff[1] = 48;
        break;              
        case 1 : steps_buff[1] = 49;
        break;              
        case 2 : steps_buff[1] = 50;
        break;              
        case 3 : steps_buff[1] = 51;
        break;              
        case 4 : steps_buff[1] = 52;
        break;              
        case 5 : steps_buff[1] = 53;
        break;              
        case 6 : steps_buff[1] = 54;
        break;              
        case 7 : steps_buff[1] = 55;
        break;              
        case 8 : steps_buff[1] = 56;
        break;              
        case 9 : steps_buff[1] = 57;
        break;
        default :break;
      }
      switch(steps_buff[2]){
        case 0 : steps_buff[2] = 48;
        break;              
        case 1 : steps_buff[2] = 49;
        break;              
        case 2 : steps_buff[2] = 50;
        break;              
        case 3 : steps_buff[2] = 51;
        break;              
        case 4 : steps_buff[2] = 52;
        break;              
        case 5 : steps_buff[2] = 53;
        break;              
        case 6 : steps_buff[2] = 54;
        break;              
        case 7 : steps_buff[2] = 55;
        break;              
        case 8 : steps_buff[2] = 56;
        break;              
        case 9 : steps_buff[2] = 57;
        break;
        default :break;
      }
      switch(steps_buff[3]){
        case 0 : steps_buff[3] = 48;
        break;              
        case 1 : steps_buff[3] = 49;
        break;              
        case 2 : steps_buff[3] = 50;
        break;              
        case 3 : steps_buff[3] = 51;
        break;              
        case 4 : steps_buff[3] = 52;
        break;              
        case 5 : steps_buff[3] = 53;
        break;              
        case 6 : steps_buff[3] = 54;
        break;              
        case 7 : steps_buff[3] = 55;
        break;              
        case 8 : steps_buff[3] = 56;
        break;              
        case 9 : steps_buff[3] = 57;
        break;
        default :break;
      }
      switch(steps_buff[4]){
        case 0 : steps_buff[4] = 48;
        break;              
        case 1 : steps_buff[4] = 49;
        break;              
        case 2 : steps_buff[4] = 50;
        break;              
        case 3 : steps_buff[4] = 51;
        break;              
        case 4 : steps_buff[4] = 52;
        break;              
        case 5 : steps_buff[4] = 53;
        break;              
        case 6 : steps_buff[4] = 54;
        break;              
        case 7 : steps_buff[4] = 55;
        break;              
        case 8 : steps_buff[4] = 56;
        break;              
        case 9 : steps_buff[4] = 57;
        break;
      default :break;
      }
      ...
      steps_buff[5] = 'a';
      steps_buff[6] = 'b';
      SampleApp_SendPeriodicMessage(steps_buff, 7 );
    }
    printInt(steps);
    // return unprocessed events
